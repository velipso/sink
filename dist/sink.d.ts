...
export declare function castnum(v: val): number;
export declare function caststr(str: val): string;
export declare function castlist(ls: val): list;
...
export declare function scr_new(inc: inc_st, curdir: strnil, repl: boolean): scr;
...
export declare function list_setuser(ctx: ctx, ls: list, usertype: user, user: any): void;
export declare function list_hasuser(ctx: ctx, ls: list, usertype: user): boolean;
