...
var OP_NIL           = 0x04; // [TGT]
var OP_NUM8          = 0x05; // [TGT], VALUE
var OP_NUM16         = 0x06; // [TGT], [VALUE]
var OP_NUM32         = 0x07; // [TGT], [[VALUE]]
var OP_NUMTBL        = 0x08; // [TGT], [INDEX]
var OP_STR           = 0x09; // [TGT], [INDEX]
var OP_LIST          = 0x0A; // [TGT], HINT
var OP_ISNUM         = 0x0B; // [TGT], [SRC]
var OP_ISSTR         = 0x0C; // [TGT], [SRC]
var OP_ISLIST        = 0x0D; // [TGT], [SRC]
var OP_NOT           = 0x0E; // [TGT], [SRC]
var OP_SIZE          = 0x0F; // [TGT], [SRC]
var OP_TONUM         = 0x10; // [TGT], [SRC]
var OP_CAT           = 0x11; // [TGT], [SRC1], [SRC2]
var OP_LT            = 0x12; // [TGT], [SRC1], [SRC2]
var OP_LTE           = 0x13; // [TGT], [SRC1], [SRC2]
var OP_NEQ           = 0x14; // [TGT], [SRC1], [SRC2]
var OP_EQU           = 0x15; // [TGT], [SRC1], [SRC2]
var OP_GETAT         = 0x16; // [TGT], [SRC1], [SRC2]
var OP_SLICE         = 0x17; // [TGT], [SRC1], [SRC2], [SRC3]
var OP_SETAT         = 0x18; // [SRC1], [SRC2], [SRC3]
var OP_SPLICE        = 0x19; // [SRC1], [SRC2], [SRC3], [SRC4]
var OP_JUMP          = 0x1A; // [[LOCATION]]
var OP_JUMPTRUE      = 0x1B; // [SRC], [[LOCATION]]
var OP_JUMPFALSE     = 0x1C; // [SRC], [[LOCATION]]
var OP_CALL          = 0x1D; // [TGT], [SRC], LEVEL, [[LOCATION]]
var OP_NATIVE        = 0x1E; // [TGT], [SRC], [INDEX]
var OP_RETURN        = 0x1F; // [SRC]
var OP_RETURNTAIL    = 0x20; // [SRC], [[LOCATION]]
var OP_RANGE         = 0x21; // [TGT], [SRC1], [SRC2], [SRC3]
var OP_SAY           = 0x22; // [TGT], [SRC...]
var OP_WARN          = 0x23; // [TGT], [SRC...]
var OP_ASK           = 0x24; // [TGT], [SRC...]
var OP_EXIT          = 0x25; // [TGT], [SRC...]
var OP_ABORT         = 0x26; // [TGT], [SRC...]
var OP_NUM_NEG       = 0x27; // [TGT], [SRC]
var OP_NUM_ADD       = 0x28; // [TGT], [SRC1], [SRC2]
var OP_NUM_SUB       = 0x29; // [TGT], [SRC1], [SRC2]
var OP_NUM_MUL       = 0x2A; // [TGT], [SRC1], [SRC2]
var OP_NUM_DIV       = 0x2B; // [TGT], [SRC1], [SRC2]
var OP_NUM_MOD       = 0x2C; // [TGT], [SRC1], [SRC2]
var OP_NUM_POW       = 0x2D; // [TGT], [SRC1], [SRC2]
var OP_NUM_ABS       = 0x2E; // [TGT], [SRC]
var OP_NUM_SIGN      = 0x2F; // [TGT], [SRC]
var OP_NUM_MAX       = 0x30; // [TGT], [SRC...]
var OP_NUM_MIN       = 0x31; // [TGT], [SRC...]
var OP_NUM_CLAMP     = 0x32; // [TGT], [SRC1], [SRC2], [SRC3]
var OP_NUM_FLOOR     = 0x33; // [TGT], [SRC]
var OP_NUM_CEIL      = 0x34; // [TGT], [SRC]
var OP_NUM_ROUND     = 0x35; // [TGT], [SRC]
var OP_NUM_TRUNC     = 0x36; // [TGT], [SRC]
var OP_NUM_NAN       = 0x37; // [TGT]
var OP_NUM_INF       = 0x38; // [TGT]
...
var OP_LIST_SHIFT    = 0x7A; // [TGT], [SRC]
var OP_LIST_POP      = 0x7B; // [TGT], [SRC]
var OP_LIST_PUSH     = 0x7C; // [TGT], [SRC1], [SRC2]
var OP_LIST_UNSHIFT  = 0x7D; // [TGT], [SRC1], [SRC2]
var OP_LIST_APPEND   = 0x7E; // [TGT], [SRC1], [SRC2]
var OP_LIST_PREPEND  = 0x7F; // [TGT], [SRC1], [SRC2]
var OP_LIST_FIND     = 0x80; // [TGT], [SRC1], [SRC2], [SRC3]
var OP_LIST_RFIND    = 0x81; // [TGT], [SRC1], [SRC2], [SRC3]
var OP_LIST_JOIN     = 0x82; // [TGT], [SRC1], [SRC2]
var OP_LIST_REV      = 0x83; // [TGT], [SRC]
var OP_LIST_STR      = 0x84; // [TGT], [SRC]
var OP_LIST_SORT     = 0x85; // [TGT], [SRC]
var OP_LIST_RSORT    = 0x86; // [TGT], [SRC]
var OP_LIST_SORTCMP  = 0x87; // [TGT], [SRC1], [SRC2]
var OP_PICKLE_VALID  = 0x88; // [TGT], [SRC]
var OP_PICKLE_STR    = 0x89; // [TGT], [SRC]
var OP_PICKLE_VAL    = 0x8A; // [TGT], [SRC]
var OP_GC_GETLEVEL   = 0x8B; // [TGT]
var OP_GC_SETLEVEL   = 0x8C; // [TGT], [SRC]
var OP_GC_RUN        = 0x8D; // [TGT]
...
function op_num(b, tgt, num){
	oplog('NUM', tgt, num);
	if (num >= -128 && num < 128)
		b.push(OP_NUM8, tgt.fdiff, tgt.index, num < 0 ? 256 + num : num);
	else if (num >= -32768 && num < 32768){
		if (num < 0)
			num += 65536;
		b.push(OP_NUM16, tgt.fdiff, tgt.index, num & 0xFF, num >> 8);
	}
	else{
		b.push(OP_NUM32, tgt.fdiff, tgt.index,
			num & 0xFF,
			(num >> 8) & 0xFF,
			(num >> 16) & 0xFF,
			(num >> 24) & 0xFF);
		...
		switch (ops[ctx.pc]){
			...
			case OP_NUM16          : { // [TGT], [VALUE]
				...
				if (A > ctx.lex_index)
					return crr_invalid(ctx);
				C |= D << 8;
				var_set(ctx, A, B, C >= 32768 ? C - 65536 : C);
			} break;
			...
			case OP_NUM32          : { // [TGT], [[VALUE]]
				...
				if (A > ctx.lex_index)
					return crr_invalid(ctx);
				var_set(ctx, A, B, C | (D << 8) | (E << 16) | (F << 24));
			} break;
